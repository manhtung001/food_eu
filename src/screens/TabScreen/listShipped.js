...
const listShippedScreen = (props) => {
  ...
  const getListShipped = async () => {
    ...
    if (res.data.orderShippedInfos.length < LIMIT_DATA) {
      CAN_LOAD_MORE = false;
    }
  ...
  const loadMore = async () => {
    ...
    setListShipped(listShipped.concat(res.data.orderShippedInfos));
  }
